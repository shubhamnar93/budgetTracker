    ...
    <div className="mt-7 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-3">
        <button
          ...
          //   onClick={() => setSelectedQuickAction("expense")}
        >
        ...
        <button
          ...
          //   onClick={() => setSelectedQuickAction("income")}
        >
          <div className="flex items-center">
        ...
        <button className="group flex w-full items-center justify-between rounded-xl bg-gradient-to-r from-purple-50 to-purple-100 p-4 transition-all duration-200 hover:from-purple-100 hover:to-purple-200">
          <div className="flex items-center">
